...
back_tuples = [0.25, [120, 10, 70, 400]], [0.25, [280, 30, 40, 400]],
back_tuples += [0.5, [30, 40, 40, 400]], [0.5, [130, 90, 100, 400]], [0.5, [300, 80, 120, 400]]

background_objects = [*back_tuples]
...
while True:  # Loop in game
    ...
    for background_object in background_objects:
        obj_tuples = background_object[1][0]-scroll[0]*background_object[0],
        obj_tuples += background_object[1][1]-scroll[1]*background_object[0],
        obj_tuples += background_object[1][2], background_object[1][3]

        obj_rect = pygame.Rect(*obj_tuples)
    ...
    for event in pygame.event.get():  # Event lopping.
        ...
        if event.type == KEYDOWN:  # Checks if a key has been pressed.
            if event.key == K_w:
                pygame.mixer.music.fadeout(1000) # Turn down the music volume

            if event.key == K_e:
                pygame.mixer.music.fadeout(-1) # Turn off the music
